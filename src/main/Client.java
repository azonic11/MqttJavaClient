...
public class Client implements MqttCallback {
    ...
    String url = protocol + broker + ":" + port;
		...
		try {
			...
			Client sampleClient = new Client (url, clientId, cleanSession, quietMode,userName,password);
			...
			if (action.equals("publish")) {
				...
				//sampleClient.publish(topic,qos,message.getBytes());
				sampleClient.subscribe("badRoom/temp",qos);
			//	sampleClient.subscribe("badRoom/mainLight",qos);
   ...
   * @param password the password for the user
	 ...
	 */
    public Client(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName, String password) throws MqttException {
    ...
    public void subscribe(String topicName, int qos) throws MqttException {
    	...
    	client.subscribe("badRoom/mainLight", qos);
    	//client.subscribe("badRoom/mainLight", qos);
